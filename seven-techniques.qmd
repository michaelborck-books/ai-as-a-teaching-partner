...
1. **Reverse Prompt:** "What factors must be considered in organizational change?"
...
- Finance: Identify question → Gather data → Analyze alternatives → Justify decision → Present findings
...
[Student analyzes, you refine together]
